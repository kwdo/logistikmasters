...
class ForumAppController extends AppController {
	 ...
	 * @var array
	 */
	public $components = array('Session', 'Security', 'Cookie', 'Auth', 'Forum.ForumToolbar', 'Forum.AutoLogin','RequestHandler');
	 ...
	 * @var array
	 */
	public $helpers = array('Html', 'Session', 'Form', 'Time', 'Text', 'Forum.Common','Rss');
