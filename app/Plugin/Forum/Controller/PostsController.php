	...
	public function add($slug, $quote_id = null) {
		...
		if (!empty($this->request->data)) {
			...
			if ($post_id = $this->Post->add($this->request->data['Post'])) {
				...
				$body = "Es wurde ein neuer Post erstellt:" . PHP_EOL;
				$body .= 'https://' . $_SERVER['HTTP_HOST'] . ' /forum/topics/view/' . $topic['Topic']['slug'] . PHP_EOL . PHP_EOL;
				$body .= $this->request->data['Post']['content'] . PHP_EOL;
				$recipents = array(
