<div class="questionsUsers index">
	<h2><?php echo __('Questions Users'); ?></h2>
	...
	<?php
	foreach ($questionsUsers as $questionsUser): ?>
	<tr>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $questionsUser['QuestionsUser']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $questionsUser['QuestionsUser']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $questionsUser['QuestionsUser']['id']), null, __('Are you sure you want to delete # %s?', $questionsUser['QuestionsUser']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
