		...
		switch ($name) {
            ...
            case 'month':
                if ($options['monthNames'] === true) {
                    $data['01'] = __d('cake', 'Januar');
                    $data['02'] = __d('cake', 'Februar');
                    $data['03'] = __d('cake', 'März');
                    $data['04'] = __d('cake', 'April');
                    $data['05'] = __d('cake', 'Mai');
                    $data['06'] = __d('cake', 'Juni');
                    $data['07'] = __d('cake', 'Juli');
                    $data['08'] = __d('cake', 'August');
                    $data['09'] = __d('cake', 'September');
                    $data['10'] = __d('cake', 'Oktober');
                    $data['11'] = __d('cake', 'November');
                    $data['12'] = __d('cake', 'Dezember');
